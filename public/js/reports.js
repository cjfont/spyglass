  ...
  vpcs: function(callback) {
    $.ajax({
      ...
      success: function(data) {
        ...
        var data_table = _.map(data, function(vpc) {
          var tags = _.object(_.map(vpc.Tags, function(tag) {
            return [tag.Key, tag.Value];
          }));
          return [vpc.VpcId, tags, vpc.CidrBlock, vpc.Region];
        });
  ...
  external_ips: function(callback) {
    $.ajax({
      ...
      success: function(data) {
        ...
        var data_table = _.map(data, function(addr) {
          ...
          */
          return [addr.PublicIp, inst, addr.PrivateIpAddress, addr.Domain, addr.Region];
        });
  ...
  instances: function(callback) {
    $.ajax({
      ...
      success: function(data) {
        ...
        var data_table = _.flatten(_.map(data, function(resv) {
          return _.map(resv.Instances, function(inst) {
  ...
  security_groups: function(callback) {
    $.ajax({
      ...
      success: function(data) {
        ...
        var data_table = _.map(data, function(secgrp) {
          var properties = {
  ...
  subnets: function(callback) {
    $.ajax({
      ...
      success: function(data) {
        ...
        var data_table = _.map(data, function(subnet) {
